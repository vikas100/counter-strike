...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"131 179 43 255"	// used in text windows, lists
		"BrightBaseText"		"0 0 0 255"	// brightest text
		"SelectedText"		"0 0 0 255"	// selected text
		"DimBaseText"		"0 0 0 255"	// dim base text
		"LabelDimText"		"0 0 0 255"	// used for info text
		"ControlText"		"0 0 0 255"	// used in all text controls
		"BrightControlText"	"131 179 43 255"	// use for selected controls
		"DisabledText1"		"0 0 0 255"	// disabled text
		"DisabledText2"		"0 0 0 0"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"0 0 0 255"	// offline friends, unsubscribed games, etc.

		"ButtonFocusBorder"	"64 48 0 255"	// keyboard focus dashed line for buttons

		// background colors
		"ControlBG"			"131 179 43 0"		// background color of most controls
		"ButtonBG"			"131 179 43 64"		// background color of buttons
		"ControlDarkBG"		"131 179 43 128"		// darker background color; used for background of scrollbars
		"WindowBG"			"131 179 43 200"		// background color of text edit panes (chat, text entries, etc.)
		//"SelectionBG"		"192 28 0 140"	// background color of any selected text or menu item
		"SelectionBG"		"120 165 40 200"	// background color of any selected text or menu item
		"SelectionBG2"		"255 255 255 16"		// selection background in window w/o focus
		"ListBG"			"0 0 0 96"		// background of scoreboard
		"ViewportBG"		"0 0 0 200"
		"CareerBoxBG"		"0 0 0 200"
		"Menu/BgColor"		"131 179 43 227"
		...
		// titlebar colors
		"TitleText"			"120 165 40 255"
		"TitleDimText"		"120 165 40 255"
		"TitleBG"			"255 255 0 0"
		"TitleDimBG"		"255 255 0 0"
		"TitleIcon"		"120 165 40 255" // big '!' icon in top left
		...
		// border colors
		"BorderBright"		"0 0 0 128"	// the lit side of a control
