...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"120 140 165 255"	// used in text windows, lists
		"BrightBaseText"		"120 140 165 255"	// brightest text
		"SelectedText"		"0 0 0 255"	// selected text
		"DimBaseText"		"125 155 188 255"	// dim base text
		"LabelDimText"		"120 140 165 255"	// used for info text
		"ControlText"		"120 140 165 255"	// used in all text controls
		"BrightControlText"	"120 140 165 255"	// use for selected controls
		"DisabledText1"		"236 236 236 255"	// disabled text
		"DisabledText2"		"150 150 150 255"	// overlay color for disabled text (to give that inset look)
		"DimListText"		"100 115 125 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"230 237 245 255"		// background color of controls
		"ControlDarkBG"		"154 167 183 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"230 237 245 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"69 113 162 255"	// background color of any selected text or menu item
		"SelectionBG2"		"160 160 160 255"		// selection background in window w/o focus
		"ListBG"			"188 201 215 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"56 84 105 255"
		"TitleDimText"		"79 120 157 255"
		"TitleBG"			"230 237 245 255"
		"TitleDimBG"		"230 237 245 0"
		
		// slider tick colors
		"SliderTickColor"		"179 213 234 255"
		"SliderTrackColor"	"50 110 152 255"

		// border colors
		"BorderBright"		"191 206 216 255"	// the lit side of a control
		"BorderDark"		"125 134 144 255"		// the dark/unlit side of a control
		"BorderSelection"		"125 134 144 255"			// the additional border color for displaying the default/selected button
	}
